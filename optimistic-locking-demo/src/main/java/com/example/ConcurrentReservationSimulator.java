...
public class ConcurrentReservationSimulator {
    ...
    // Main apres modification
    public static void main(String[] args) throws InterruptedException {
        // Initialisation des données
        initData();

        // 1- Simulation d'un conflit de réservation concurrent sans retry
        ...
        // 2-Simulation d'un conflit de réservation concurrent avec retry
    ...
    private static void initData() {
        ...
        Utilisateur utilisateur1 = new Utilisateur("Bajadda", "Asma", "asma.baj@example.com");
        Utilisateur utilisateur2 = new Utilisateur("Chafiq", "Sophie", "sophie.chafiq@example.com");


        Salle salle = new Salle("Salle A307", 30);
